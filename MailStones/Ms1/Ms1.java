...
public class Ms1 {
    ...
    public static void top(JFrame frame0) {
        ...
        JCheckBox checkBox1 = new JCheckBox("Clavel", true);
        JCheckBox checkBox2 = new JCheckBox("Roses");
    ...
    public static void right(JFrame frame0) {
        ...
        east.setLayout(new BoxLayout(east, BoxLayout.Y_AXIS)); // change X_AXIS to Y_AXIS
    ...
    public static void middle(JFrame frame0) {
        ...
        for (int i = 0; i < 4; i++) {
            // use relative path to image instead of absolute path
            center.add(new JLabel(new ImageIcon("./src/MailStones/Ms1/1.png")));
        }
    }
    ...
    public static void showFrame() {
        JFrame frame0 = new JFrame("MileStones1");
